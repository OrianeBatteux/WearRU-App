...
class ShopViewModel: ObservableObject {
    ...
    init() {
        shops = [
            ...
            Shop(shopName: "Belle et Fashion", shopImage: "CardShop_9", shopOpening: true, shopHours: "Lun-Sam: 10:00 – 20:30 \nDim: 10:00 – 19:00", shopPhone: "01 03 87 27 98", shopLocation: Location(coordinate : CLLocationCoordinate2D(latitude: 48.87305392456055, longitude: 2.4757637252807617), address: "Westfield Rosny 2")),
